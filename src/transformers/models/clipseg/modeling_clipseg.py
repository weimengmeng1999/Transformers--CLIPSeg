...
class CLIPSegForImageSegmentation(CLIPSegPreTrainedModel):
    ...
    @replace_return_docstrings(output_type=CLIPSegImageSegmentationOutput, config_class=CLIPSegTextConfig)#fix
    def forward(
        self,
        ...
        #return_loss: Optional[bool] = None, ##addition
        output_attentions: Optional[bool] = None,
        output_hidden_states: Optional[bool] = None,
        return_dict: Optional[bool] = None,
    ) -> Union[Tuple, CLIPSegOutput]:
        ...
        if labels is not None:
          ...
          loss = loss_fn(logits, labels) # Meng: in the forward it said to keep labels to be long type, but in BCE should be float
